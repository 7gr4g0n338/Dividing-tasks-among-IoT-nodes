...
public class TempSensor {
	...
	private static String aeName = "tempsensor";
	...
	public static void main(String[] args) {
		...
		//tao noi dung conteninstance va gui cho mn	
			obj = new JSONObject();
			obj.put("cnf", "application/textTemp");
	...
	public static int getSensorValue(){
		TempsensorValue = 10+(int)(Math.random()*40);
		System.out.println("TempSensor value = "+TempsensorValue);
